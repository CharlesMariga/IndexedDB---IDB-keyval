...
(()=>{
    const st = (0, _idbKeyval.createStore)("MyDB", "mystore");
    /**
   * This overwrites old values and writes new ones.
   */ (0, _idbKeyval.set)("user_id", Date.now(), st).then(()=>{
    ...
    (0, _idbKeyval.set)("info", myobj).then(()=>{
        console.log("saved the info");
    }).catch;
    (0, _idbKeyval.get)("info").then((data)=>{
        console.log(data);
    }).catch(console.warn);
    /**
   * Update overwrites the value
   */ (0, _idbKeyval.update)("user_id", (val)=>val - 1000).then((data)=>{
        console.log("update complete");
    }).catch(console.warn);
    (0, _idbKeyval.keys)().then((resp)=>{
        console.log(resp);
    });
    (0, _idbKeyval.values)().then((resp)=>{
        console.log("Values: ", resp);
    }).catch(console.warn);
    (0, _idbKeyval.entries)().then((res)=>{
        console.log("Entries: ", res);
    }).catch(console.warn);
})();

},{"idb-keyval":"lciyz"}],"lciyz":[function(require,module,exports) {
...
},{}]},["7Aums","bNKaB"], "bNKaB", "parcelRequire5158")
